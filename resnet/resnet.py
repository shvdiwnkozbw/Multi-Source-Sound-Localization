...
model_dir = {'resnet18': './resnet/resnet18-5c106cde.pth',
             'resnet50': '/home/yuxi/ruiq/AudioVisual/v8/resnet/resnet50-19c8e357.pth'}
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, additional=None):
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        try:
            ...
            model.load_state_dict(state_dict, strict=False)
            torch.save(model.layer4, 'layer4.pkl')
            model.layer5 = torch.load('layer4.pkl')
    return model
